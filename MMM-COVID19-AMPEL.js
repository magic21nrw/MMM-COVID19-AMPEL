...
Module.register("MMM-COVID19-AMPEL", {
  ...
  getHeader: function () {
    ...
    if (this.config.showVaccinations && !(this.globalVaccinations === null || this.globalVaccinations === undefined ))
      headerTitle += " - " + vaccinationsLabel + " " + this.globalVaccinations.toFixed(this.config.numberOfDigits) + "% / " + this.globalSecondVaccination.toFixed(this.config.numberOfDigits) + "% / " + this.globalThirdVaccination.toFixed(this.config.numberOfDigits);
    return headerTitle;
  },
